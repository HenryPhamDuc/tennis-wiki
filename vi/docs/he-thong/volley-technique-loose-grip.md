---
title: "Volley Technique - Loose Grip"
language: vi
vault: Hệ thống Tennis
created: 2026-06-21
sub_system: "Wave theory"
vault_path: "Hệ  thong\Wave theory\Volley Technique - Loose Grip.md"
---
...
A loose grip (3–4/10) allows the handle a small "mini-movement" (2–3 mm) on impact. This:
- Slightly lengthens contact time (milliseconds matter)
- Lowers peak force: FΔt = mΔv — softer F = more control over Δv
- Bleeds off pace rather than reflecting it → the drop volley becomes possible
...
A light hold keeps:
- Thumb pad and base of index finger as the primary contact points
- Clear bevel orientation feedback without wrist lock
- Last-instant micro-adjustments available (open/close face 1–2° via thumb alone)
...
The notes reference continental grip mechanics: thumb down (pressing the back bevel), three fingers providing counter-pressure. This geometry:
- Naturally creates the stable bevel for both high and low volleys without grip change
- Works with, not against, the loose-grip principle — the thumb provides structural feel while the fingers stay soft
...
1. **SET**: Racket face fixed early, elbow in front, wrist firm (not tight) — this is the pre-contact structural stability
2. **MEET**: Step or shift toward ball, contact in front of body — the redirect, not a punch
3. **SLICE**: Allow racket to move slightly downward through contact — the "take the pace away" action that gives the volley backspin and control
...
In [Power Wave Theory](../ky-thuat/power-wave-theory.md) terms, the volley does not use a full ground-to-racket wave. The wave is short — essentially a wrist/forearm wave only. The front foot plants (the brake) very early, the wave "plummets," and the stored forces redirect the ball.
