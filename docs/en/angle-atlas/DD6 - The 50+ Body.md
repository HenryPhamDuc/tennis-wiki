...
| **Figure 1 / Hình 1** — Multifidus (deep layer of the back). Each segmental muscle controls 1–2 vertebrae. |
...
| **Figure 2 / Hình 2** — Eccentric squat on a 25° decline board. The decline shifts load to the patellar tendon specifically. |
...
| **Figure 3 / Hình 3** — Hip CARs in action. Slowly rotate hip through full range, both directions. |
...
| **Figure 4 / Hình 4** — Walking with hip hinge preserved. The back stays long; hips move first. |
...
| **Figure 5 / Hình 5** — Wider stance forehand loading. The glute max fires first; the knee stays aligned over the 2nd toe. |
...
| **Figure 8 / Hình 8** — The 50+ use-it-or-lose-it principle. Tennis is protective. Stopping accelerates decline. |
