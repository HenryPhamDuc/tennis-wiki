...
| **Figure 1 / Hình 1** — The 4 rotator cuff muscles (SITS: supraspinatus, infraspinatus, teres minor, subscapularis). These are the SHOULDERS LIGAMENTS — small but essential. |
...
| **Figure 2 / Hình 2** — Subacromial space. Notice the supraspinatus tendon passing through the narrow gap. |
...
| **Figure 3 / Hình 3** — Scapular plane: the arm reaches forward 30°–40°, not straight lateral. This position opens the subacromial space by ~2 mm. |
...
| **Figure 4 / Hình 4** — Cubital tunnel at full extension (left) vs at 90° flexion (right). The space shrinks dramatically. |
...
| **Figure 5 / Hình 5** — Patellar tendon from quadriceps to tibia. The kneecap (patella) sits embedded in the tendon like a pulley. |
...
| **Figure 6 / Hình 6** — Big-toe extension tightens the plantar fascia like a windlass, raising the arch. |
