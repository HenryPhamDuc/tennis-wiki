...
| **Figure 1 / Hình 1** — The 3 semicircular canals (anterior, posterior, horizontal) detect head rotation. The 2 otolith organs detect linear acceleration and head tilt. |
| ![Otoconia in vestibular system](images/DD8_control_system/Anatomy_He_Tien_Dinh_Full__img09.png) |
| **Figure 2 / Hình 2** — Otoconia: tiny calcium carbonate crystals in the otolith organs. **These move with gravity** and tell the brain which way is UP. |
...
| **Figure 9 / Hình 9** — The dense nerve endings in the sole. 7,000+ sensors in each foot. |
