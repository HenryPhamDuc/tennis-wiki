...
### Figure 1 — Inner Ear 3D Model with Vestibular System Labeled

`images/DD8_control_system/Anatomy_He_Tien_Dinh_Full__img01.png` (Hình 1, 0.0s)

### Figure 2 — Hidden Network in Temporal Bone

`images/DD8_control_system/Anatomy_He_Tien_Dinh_Full__img02.png` (Hình 2, 2.1s)

### Figure 3 — Full Body with Vestibular Nerve Pathway Glowing
