...
| Phase |  Description | Vietnamese | Duration | Key Angle / Cue |
|---|---|---|---|---|
...
|---|---|---|
| Backswing | Posterior deltoid, infraspinatus, teres minor, trapezius, rhomboids, serratus anterior (eccentric) | `images/DD1_player_in_motion/DD1_player_in_motion_01.png` (Tennis Anatomy rendering) |
...
| Hình | Description | Image |
|---|---|---|
| 13 | Semi-open stance loading — shoulder rotated away from hip | `images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img13.png` |
...
| 20 | 5:30 position — hand level with hip, racket head up | `images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img20.png` |
...
| Hình | Description | Image |
|---|---|---|
| 22 | Drive legs — knee flexed, push into ground | `images/DD1_player_in_motion/Giai_Phau_Tennis_Toan_Dien__img22.png` |
