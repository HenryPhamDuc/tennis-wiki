...
### Figure 1 — Wider Stance → Glutes Activated

`images/DD5_hips_thighs/Anatomy_Tennis_Full___img01.png` (Hình 1)

### Figure 2 — Inner Thighs Start Doing the Work (Adductors)

`images/DD5_hips_thighs/Anatomy_Tennis_Full___img02.png` (Hình 2)

### Figure 3 — Glutes Stronger, Quads Lose Tension

`images/DD5_hips_thighs/Anatomy_Tennis_Full___img03.png` (Hình 3)

### Figure 4 — Deep Rotators Marked (The 6 Hidden Muscles)

`images/DD5_hips_thighs/Anatomy_Tennis_Full___img04.png` (Hình 4)

### Figure 5 — Lack of Control (Restricted Outflow)

`images/DD5_hips_thighs/Anatomy_Tennis_Full___img05.png` (Hình 5)

### Figure 6 — Loss of Control Inside Joint

`images/DD5_hips_thighs/Anatomy_Tennis_Full___img06.png` (Hình 6)

### Figure 7 — Activate Deep Stabilizers

`images/DD5_hips_thighs/Anatomy_Tennis_Full___img07.png` (Hình 7)

### Figure 8 — Capsule Opening (After CARs)

`images/DD5_hips_thighs/Anatomy_Tennis_Full___img08.png` (Hình 8)

### Figure 9–13 — Forearm/Thumb Integration (Reference to DD3)

`images/DD5_hips_thighs/Anatomy_Tennis_Full___img09.png` through `img13.png`
