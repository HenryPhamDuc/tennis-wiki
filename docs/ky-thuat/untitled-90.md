---
title: "7. Giới thiệu – Tại sao “Footwork” là nền tảng?"
tags:
  - cẩm-nang
  - ollama
source: "Can-Ban\\untitled-90.md"
updated: 2026-06-20
---
...
\[
\boxed{
\text{Performance}_{\text{move}} \;=\; 
\underbrace{\frac{I_{\text{CM}}}{m_{\text{player}}}}_{\text{Inertia factor}} 
\;\times\; 
\underbrace{e^{-\lambda \, \Delta \theta_{\text{slide}}}}_{\text{DSI decay}} 
\;\times\; 
\underbrace{S_{\text{gravity}}}_{\text{GSM boost}}
}
\]
...
![1e6fafc3-0982-442c-a044-85c26aa75fb7](file:///C:/Users/Henry/Pictures/Typedown/1e6fafc3-0982-442c-a044-85c26aa75fb7.png)
...
Dưới đây là công cụ mô phỏng để bạn tự tay tinh chỉnh ba khối năng lượng này. Bạn sẽ thấy việc để mất trọng tâm (tăng góc lệch) sẽ hủy hoại điểm số di chuyển tàn nhẫn như thế nào: .
...
\[
\text{DSI} = e^{-\lambda \Delta\theta_{\text{slide}}},\qquad 
\lambda = \frac{\mu}{0,5}
\]
...
Dưới đây là một công cụ giúp bạn mô phỏng sự khắc nghiệt của các mặt sân khác nhau đối với độ ổn định cấu trúc khi bạn nghiêng người.
...
![9b448f78-d9db-4609-86e0-dcc71b688ee3](file:///C:/Users/Henry/Pictures/Typedown/9b448f78-d9db-4609-86e0-dcc71b688ee3.png)
...
![029a67d5-3a25-4011-8a84-5654f6e9b7ad](file:///C:/Users/Henry/Pictures/Typedown/029a67d5-3a25-4011-8a84-5654f6e9b7ad.png)
...
Dưới đây là công cụ giúp bạn thấy rõ năng lượng "miễn phí" từ Trái Đất có thể tăng cường hiệu suất di chuyển của bạn lên tới mức nào, nếu bạn biết cách hạ trọng tâm và duy trì độ nảy của hệ mạc: .
...
| **KPI**                             | —                                      | – `Δθ_slide` ≤ 12° trên hard, ≤ 8° trên clay. <br>– `a_explode` ≥ 5,5 m/s². <br>– `S_gravity` ≥ 1,01.                                 |
