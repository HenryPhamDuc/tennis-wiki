...
| Subsite | Description | Mô tả |
|---|---|---|
| 🎾 **Foundation** | Stroke fundamentals, grip, footwork, groundstrokes, serve, volley, return of serve, doubles, slice family, lob & overhead, mental game, 1-page pocket card, and 22 deep dives | Nền tảng kỹ thuật, grip, bộ chân, cú đánh, giao bóng, volley, trả giao bóng, đánh đôi, slice, lob & overhead, tâm lý, thẻ túi, 22 deep-dives |
| 🧠 **Advanced** | The 15-part master reference + 8 numbered deep dives (Embodied Cognition, Two Engines, Proprioception, Reflex Arcs, Tensegrity, Fascia, X-Factor, Head/Vestibular) | Cẩm nang 15 phần + 8 deep-dives đánh số |
| 🏆 **Elite** | The 14-part master reference + 13 numbered deep dives (Anti-Orthodox Manifesto, Trương Lực, Myelination, Three Models, Pressure Inoculation, Kình & Mushin, Self-Discovery, Hidden Speed, Decision Latency, Self-Coaching, HRV Dashboard, Choking & Amygdala, Dream Library) | Cẩm nang 14 phần + 13 deep-dives đánh số |
| 🦴 **Anatomy Lab** | 8 deep-dives on the body behind every stroke (Player in Motion, Shoulders, Arms/Wrists/Hands, Trunk/Spine, Hips/Thighs, Knees, Ankles/Feet, Control System) | 8 deep-dives về cơ thể đằng sau mỗi cú đánh |
| 📐 **Angle Atlas** | 7 deep-dives on the angles, springs, neurology, and sensors behind every stroke (Angle Atlas, Joints as Springs, Neurological Foundation, Muscle Hierarchy, Skeletal Architecture, 50+ Body, Sensor System) | 7 deep-dives về góc độ, lò xo, thần kinh, cảm biến |
...
## 📚 About This Resource / Giới Thiệu Về Tài Nguyên

This knowledge base represents years of research, coaching experience, and practical application. It synthesizes insights from:

Cơ sở kiến thức này là kết quả của nhiều năm nghiên cứu, kinh nghiệm huấn luyện và ứng dụng thực tiễn:

- Professional tennis methodology | Phương pháp luận quần vợt chuyên nghiệp
- Sports biomechanics and neurology | Sinh cơ học và thần kinh học thể thao
- Coaching best practices | Thực hành huấn luyện tốt nhất
- 97+ curated tennis books and documents | 97+ cuốn sách và tài liệu quần vợt được tuyển chọn

---

## 🔗 Related Resources / Tài Nguyên Liên Quan

- 🤖 **[Tennis Doctor — AI Chat](https://tennis-doctor.henry-phamduc.workers.dev/)** — Ask anything about tennis and get AI answers drawn from the wiki + 97 tennis books. Multilingual EN/VI.
- 🔬 **[Tennis Future Lab](https://henryphamduc.github.io/tennis-future-lab/)** — Biomechanics framework + AI Video Analyzer.
- 🤖 **[AI Video Analyzer (HF Space)](https://huggingface.co/spaces/HenryPhamDuc/tennis-analyzer)** — Upload tennis video → AI analyzes your technique vs Federer.
