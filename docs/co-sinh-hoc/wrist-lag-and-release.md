---
title: Wrist Lag and Release
source: Wrist Lag and Release.md
updated: 2026-06-20
---
...
It is the final amplifier in the [Kinetic Chain](../ky-thuat/kinetic-chain.md), and the most frequently destroyed by the instinct to "control" the ball by tensing the wrist.
...
1. **Stretch loading**: The forearm flexors elongate under load (stretch-shortening cycle — see [Power Wave Theory](../ky-thuat/power-wave-theory.md) elastic storage)
...
In [Power Wave Theory](../ky-thuat/power-wave-theory.md) terms: the wrist lag corresponds to the **Lag Phase** of the wave. The racket head is the most distal segment; it receives the wave last and amplifies it most.
...
| Wrist leading elbow | Biomechanical error, elbow dropped | Arm cannot transmit [Kinetic Chain](../ky-thuat/kinetic-chain.md) force efficiently |
