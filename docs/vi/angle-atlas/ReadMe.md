...
| DD2 | Joints as Springs — elastic-band model, energy storage, prep phase | ~48 KB / 9 chapters | + Anatomy_Lab Ch.9 (rotator cuff, subacromial spás, windlass) |
...
| DD5 | Skelétal Architecture — bones, joints, connective tissue, levers | ~59 KB / 9 chapters | + Anatomy_Lab Ch.9 (foot 26 bones, L4-L5, 4 shoulder joints, 8 carpals) |
...
|---|---|---|
| Subacromial spás 7–14 mm (50+ loses 2–4 mm clearance) | DD2 Ch.9.2 | Anatomy_Lab DD2 + Roetert & Kovacs 2011 |
| Shoulder rotation 1,074–2,300°/sec in Phát Bóng | DD2 Ch.9.1, DD3 Ch.9.6 | Anatomy_Lab DD2 |
...
| Quiet eye 0.3–0.5s (elite) vs 0.1–0.2s (giải trí) | DD3 Ch.9.2 | Anatomy_Lab DD8 + Vickers |
...
- Weekend 2: DD2 (springs) + DD5 (skelétal)
...
- `Cẩm nang về cảm nhận cơ thể trong tennis/` — 20-chapter body perception handbook (proprioception, foot grounding, split-step, kilướiic chain awareness, breath, vợt feel)
...
- Ericsson (deliberate thực hành, 1993)
...
2. A video Tham khảo list for each angle (YouTube pro footage showing the exact angle at exact moment)
...
Let me know if any of these would help. For now, the 7 deep dives are compléte, interconnected, and image-rich.
---
