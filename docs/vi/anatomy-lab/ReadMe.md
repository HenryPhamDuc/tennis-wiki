...
|---|---|---|---|---|---|
| DD1 | The Player in Motion | Whole-body biomechanics, kilướiic chain, di chuyển, 45° contact rule | 47 KB / 486 lines | 8 | Stroke quality is GEOMETRY, not strength. 6 joint angles at contact. |
...
| DD3 | Arms, Wrists & Hands | Ulnar nerve, cubital tunnel, 27 hand bones, cách cầm vợt pressure | 45 KB / 536 lines | 8 | STOP STRETCHING. Do nerve flossing. Grip 3/10 → 7/10 → 3/10. |
...
| DD5 | Hips & Thighs | Glute max, 6 deep rotators, wider tư thế transformation, hip CARs | 42 KB / 494 lines | 7 | Activate, don't stretch. Hip stiffness is a CONTROL problem. |
...
|---|---|---|---|
| Your Vietnamese source notes with embedded 3D anatomy renders |
| Tham khảo textbook |
...
|---|---|---|
| 1st | DD1 The Player in Motion | Foundation. The 6 joint angles, kilướiic chain, and di chuyển phases are referenced by every other DD. |
| 2nd | DD2 Shoulders + DD3 Arms/Wrists/Hands | The upper limb chain. Most tennis injuries are upper limb. Read together for the full kilướiic chain. |
...
- Shoulder impingement → DD2 → DD1 (kilướiic chain) → DD5 (glute med)
...
|---|---|---|---|
| 6 joint angles at Cú Thuận Tay contact (knee 60–70°, hip rotation 40–45°, shoulder 90–100° in scapular plane, elbow 90–100°, wrist 5–15° at CONTACT, arm 45° away from trunk) | DD1 Ch.1 | Tennis Anatomy Ch.1 + user's Giai_Phau_Tennis_Toan_Dien.docx | Geometric foundation that defines stroke quality |
| LOADED vs CONTACT wrist distinction (90–110° extension loaded → 0–20° at contact) | DD1 Ch.1 (CRITICAL TRAP callout) | User's Tennis Anatomy source | giải trí players freeze LOADED position and try to hit through it |
...
| Subacromial spás 7–14 mm (50+ loses 2–4 mm clearance) | DD2 Ch.5 | Tennis Anatomy Ch.2 | Impingement is the most common tennis shoulder injury |
| Shoulder rotation 1,074–2,300°/sec in Phát Bóng (faster than any other joint) | DD2 Ch.4 | Tennis Anatomy Ch.2 | The Phát Bóng owns your shoulder |
...
| Gluteus maximus = largest muscle (~30 kg potential force, 50% of tennis power from legs) | DD5 Ch.2 | User's Anatomy_Tennis_Full_.docx + Tennis Anatomy Ch.7 | Wider tư thế transfers load from quads to glutes |
...
| Tennis shoe trap (10 mm heel lift + 15 mm toe box narrowing destroys foot function over time) | DD7 Ch.8 | User's Giai_phau_Ban_chan_Tennis.docx | Footwear matters more than vợt |
| Vestibular system (3 semicircular canals + 2 otolith organs + hair cells + neural pathway) | DD8 Ch.2 | User's Anatomy_He_Tien_Dinh_Full.docx | The 3rd layer of the kilướiic chain |
| 5-phase visual cycle (soft eyes → lock-on → narrow focus → quiet eye → re-expand) | DD8 Ch.3 | Tennis Anatomy Ch.9 + Vickers Quiet Eye research | Pros read the bóng FASTER than consciousness |
...
- No vợt/string technology (no string tension, no vợt weight distribution) — that's a separate concern.
...
| 3 | Apply one bài tập per DD. Every DD ends with 3–4 bài tậps. Pick ONE that addresses your biggest current problem. Do it daily for 2 weeks. Then evaluate. |
...
| Image refs | All 138+47=185 images are in `Anatomy_Lab/images/DD*` folders; every Tham khảo in the MD files điểms to an existing file (verified) |
...
| C. Add an "Integration" DD | A 9th DD that brings all 8 together: "The Whole Body Cú Thuận Tay" | 2 hours |
| Produce a Vietnamese-only version (no EN column) for sharing |
| Pull together injury sections from each DD into a single Tham khảo |
