...
| 3 | The Delỗi 5-Rung Ladder (and Its Limits) | Thang 5 Nấc Mặc Định (và Giới Hạn) |
...
| Bước 2 — Gom cụm mẫu. |
| Gom sự kiện choking theo *loại trigger.* Cụm phổ biến: "điểm lớn" / "set điểm" / "lỗi biên" / "phong cách đối thủ cụ thể" / "cuối trận dài" / "thời tiết lạnh" / "không khán giả" / "khán giả xem." Mỗi cụm thành *nấc.* |
...
║ Day 5-6: High (trận-stakes) / Cao (stakes-trận) ║
║ Day 7: Real trận / Trận thật ║
║ ║
...
---
Sources / Nguồn:
- Tennis Research - Neuro athlétics - with Kwen-Ollama.md (Ch 3.6 — choking = neural hijack, amygdala activation, Ch 4.3 — pressure inoculation, startle response, choking ≠ character flaw)
- Tennis Research with Kwen-Ollama.md (Ch 2.6 — tone spectrum & choking, Ch 11.5 — pressure-inoculation bài tậps, Ch 19 — self-huấn luyện viêning integration)
