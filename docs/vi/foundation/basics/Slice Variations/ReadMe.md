...
|---|---|---|---|---|
| 1 | Slice Return | Block & redirect a big Phát Bóng | Chặn & đổi hướng Phát Bóng lớn | Daily (most common) |
| 2 | Slice Low Ball | Scoop & slide a low, skidding bóng | Múc & trượt bóng thấp, skidding | Often (every trận) |
| 3 | Slice Vôlei | Compact Vôlei with xoáy dưới | Vôlei gọn với xoáy dưới | Often (every trận) |
| 4 | Slice Drop Shot | Short, soft cắt over the lưới | Slice ngắn, mềm qua lưới | Sometimes (smart play) |
...
| # | Chapter | Role |
|---|---|---|
| 1. Ý Tưởng Chính | The cắt family, the Continental foundation, the 3 sub-families | Mental framework |
...
| Step | What I did |
|---|---|
| ABSORB | Read the existing Slice Approach deep dive (5 chapters, the 4-step pattern), the Slice Return Variation file (block & redirect), the Slice Low Ball Variation file (scoop & slide), Cú Trái Tay deep dive Ch 4 (cắt workhorse), the Vôlei deep dive (L-shape, cắt Vôlei, drop Vôlei), the Lob and Overhead deep dive (cắt defensive lob), the Mental Game deep dive (4-step ritual, 50+ edge), and the Slice Approach deep dive ReadMe (the 4 Decision Questions) |
| EXTRACT | Pulled 35+ concepts across 7 variations → grouped into 3 sub-families (Survival, Construction, Touch) → mapped to 15 cues, 7 errors, 5 bài tậps, 6 tai chi principles |
...
|---|---|
| Slice Approach | This is the FULL deep-dive of variation #7 (Slice Approach). The Slice Variations deep dive is the master Tham khảo; Slice Approach is the deep dive for one variation. |
| Slice Return Variation | The 1-page quick-Tham khảo file is now EXPANDED into the Slice Return chapter in this deep dive. The "block & redirect" principle is now in 5-chapter form. |
| Slice Low Ball Variation | The 1-page quick-Tham khảo file is now EXPANDED into the Slice Low Ball chapter. The "scoop & slide" principle is now in 5-chapter form. |
| Cú Trái Tay (Ch 4 — Slice Workhorse) | Cú Trái Tay Slice is the foundation of the cắt family. Same Continental cách cầm vợt, same xoáy dưới principles, same "phập" sound. Cú Trái Tay deep dive is the cú đánh nền foundation. |
| Vôlei (Ch 3-4 — Slice Vôlei + Drop Vôlei) | The Slice Vôlei is variation #3 in this deep dive. The Vôlei deep dive covers the L-shape and the flat Vôlei. The cắt Vôlei is a specialization. |
| Lob and Overhead (Ch 2 — Defensive Slice Lob) | The Slice Defensive Lob is variation #5 in this deep dive. The Lob and Overhead deep dive covers the full decision tree (4 situations) and the cú cao. The defensive lob is one piece. |
...
| Mental Game (Ch 2-4) | The 4-step pre-điểm ritual (bounce-breathe-body-build) applies before every cắt. The 50+ mental edge (shrug, perspective) is the same. |
...
| Next | What it covers |
|---|---|
| 4-Week Slice Plan | Week 1 Survival (Return + Low Ball), Week 2 add Counter-Punch, Week 3 add Construction (Approach + Vôlei), Week 4 add Touch (Drop Shot + Lob) |
| Compléte Manual v2 | Roll the 12 deep dives (this + 11 others) into a single ~140-page master Tham khảo |
| Slice Family for Doubles | How each of the 7 variations applies in doubles — Slice Wide Phát Bóng, Slice Return in doubles, Slice Approach in doubles, Slice Vôlei at the lưới in doubles |
...
🎾
---
Bắt đầu với Drill 1 (Continental only, 5 phút/ngày) — đó là nền tảng cho cả 7. Rồi thêm Drill 2 (cắt family shadow, 5 phút/ngày) — đó là rehearsal cho mỗi biến thể.
Trong 4 tuần, bạn sẽ có 7 tùy chọn trong tay cho 7 tình huống.
---
