...
| 2. The Lob | Defensive cắt (delỗi) + Offensive xoáy trên (Tham khảo) — cách cầm vợt, tư thế, đưa vợt ra sau, contact, aim, 50+ Cẩn thận | The insurance policy |
...
| Step | What I did |
|---|---|
| Read the Vôlei deep dive (which already covers Lob Vôlei in Ch 4) + Cú Trái Tay/Return of Phát Bóng/Footwork deep dives for series consistency + 2 skill references (bundled-vs-single-stroke, vietnamese-sound-cues) |
| Pulled 35+ concepts across the lob, cú cao, lob Vôlei, counter-cú cao, 4-situation decision tree, 50+ concerns → mapped to 15 cues, 7 errors, 5 bài tậps, 6 tai chi principles |
...
|---|---|
| Cú Thuận Tay (4 L-layer dives) | The offensive xoáy trên lob is essentially a "lifted Cú Thuận Tay" — same L1-L4 system, but with a low-to-high swing path. |
| Cú Trái Tay (Ch 2 — 2HB) | Cú Trái Tay defensive lob is "2HB with Continental + high đưa vợt ra sau" — same dominant-hand-cú đẩys principle, but the swing direction is up. |
| Vôlei (Ch 4) | Lob Vôlei + counter-cú cao were introduced as Vôlei Ch 4 sub-variations. This deep dive expands them with the 3.5+ decision tree. |
| Phát Bóng (Gravity & Rotation) | The cú cao IS a Phát Bóng that comes to you. Same cách cầm vợt (Continental), same trophy position, same finish (over the non-dominant shoulder). The user already knows 70% of the cú cao from the Phát Bóng deep dive. |
...
| 4-Week Vertical Plan | A progressive bài tập calendar: Week 1 lob đưa vợt ra sau, Week 2 Sane Smash trophy, Week 3 lob tranh bóng, Week 4 trận-situation lobs and cú caos |
🎾
---
File summary:
...
- 📄 `ReadMe.md` (this file)
Bắt đầu với Drill 1 (gãi lưng 20 lần/ngày) — đưa vợt ra sau cao là chìa khóa của mọi lob.
---
