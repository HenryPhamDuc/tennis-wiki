...
> - +1 Elevation : Part 8 Mental Game from v1 is now its own Part 13 (Mental Game) — the mental ván dephát bóngs a full chapter, not a footnote
...
| |
| --- |
| Đây là bản đồ . 22 deep dives trong thư mục `Deep Dives/` là lãnh thổ . Mỗi phần dưới đây tóm tắt ý chính, rồi chỉ anh tới deep dive đi sâu hơn. |
...
|---|---|---|
| Foundations & Grip (`Deep Dives/Foundations & Grip/`) | The interfás philosophy, 3 master cách cầm vợts, body schema, tension scale basics | ~3.5 KB — 5-min read |
| Continental Grip (`Deep Dives/Continental Grip/`) | The 9-shot universal key: Phát Bóng, Vôlei, cắt, cú cao — and why Continental is the only joint-safe cách cầm vợt | 55 KB, 5 chapters |
...
Đọc sâu hơn
> v2 adds the full Cú Trái Tay deep dive family (`Deep Dives/Cú Trái Tay/`):
> - `Cú Trái Tay — The Mirror, The Whip & The Slice.md` (~54 KB, 5 chapters) — 2HB system + cắt
> - `One-Handed Cú Trái Tay — The Full Deep Dive.md` (~79 KB) — 1HB system with Dimitrov/Wawrinka/Federer archetypes
...
| "Racket fás open, like a hood" | "Mặt vợt mở, như mui xe" |
| "Slice = under the bóng, not over" | "Slice = dưới bóng, không phải trên" |
...
| Deep Dive | What it covers | Đọc sâu |
|---|---|---|
| Doubles Tactics | Communication, formations, 50+ longevity ván | `Deep Dives/Doubles Tactics/` (~52 KB) |
...
|---|---|---|---|---|---|---|---|
| Defensive lob | You're under pressure, both opponents at lưới | High arc, deep, buys 5-8 seconds | 3/10 → 7/10 | Phòng thủ | Dưới áp lực, cả hai ở lưới | Cao vòng, sâu, mua 5-8 giây | 3 → 7 |
...
|---|---|---|
| Trigger | Ball above lưới, slow, you have time | High bóng, must put away NOW |
| Footwork | Side-shuffle to set, both hands up | Run-back, single balance foot |
| Trophy pose | Full Phát Bóng-like trophy, knee bent | Compressed trophy, knee deeply bent |
| Pressure | 3/10 → 9/10 | 5/10 → 10/10 |
| Elbow risk | Low (no wrist snap) | High (wrist snap on tight bóng) |
| 50+ verdict | Delỗi — use this | Tham khảo only |
...
| Thế trophy | Trophy đầy đủ như Phát Bóng, gối gập | Trophy nén, gối gập sâu |
...
| Concern | English | Tiếng Việt |
|---|---|---|
| Shoulder | The cú cao is the most shoulder-stressing shot. Use the Sane Smash by delỗi — full trophy, low pressure until impact. | Smash là cú căng vai nhất. Dùng Sane Smash mặc định — trophy đầy đủ, áp lực thấp đến lúc chạm. |
...
| Deep Dive | What it covers | Đọc sâu |
|---|---|---|
| Slice Variations | The 7-shot Swiss Army Knife — defensive, attacking, approach, return, Vôlei, lob, dropshot | `Deep Dives/Slice Variations/` (~59 KB) |
...
|---|---|---|---|---|---|---|---|---|
| 1 | Defensive cắt | Under pressure, deep back, buy time | 3 → 7 | Continental | Phòng thủ | Dưới áp lực, lùi sâu, mua thời gian | 3 → 7 | Continental |
| 2 | Attacking cắt | Short bóng, opponent deep, cú đẩy through | 3 → 8 | Continental | Tấn công | Bóng ngắn, đối thủ sâu, đánh xuyên | 3 → 8 | Continental |
| 3 | Approach cắt | Mid-court bóng, transitioning to lưới | 3 → 8 | Continental | Approach | Bóng giữa sân, lên lưới | 3 → 8 | Continental |
| 4 | Return cắt | Big Phát Bóng, defensive return | 2 → 8 | Continental | Return | Phát Bóng mạnh, return phòng thủ | 2 → 8 | Continental |
...
| 2 | Rotator cuff strain | Muscle Phát Bóng, frozen-arm follow-through, cú cao too heavy | Gravity Phát Bóng, follow-through, Sane Smash (Part 9), ice after heavy hitting |
...
|---|---|---|---|---|---|
| "pực" | Clean xoáy trên | 4 → 8 (correct) | "pực" | Topspin sạch | 4 → 8 (đúng) |
| "bộp" | Flat punch | 6 → 9 (too early) | "bộp" | Đấm phẳng | 6 → 9 (sớm quá) |
| "bịch" | Yielding to pás | 1 → 7 (block correct) | "bịch" | Nhường đà | 1 → 7 (block đúng) |
...
| # | Rule | Quy tắc |
|---|---|---|
| 1 | If your forearm is sore at the end of a trận, your pressure was too high on at least one stroke. Find it. | Nếu cẳng tay mỏi cuối trận, áp lực bạn quá cao ở ít nhất một cú. Tìm nó. |
| 2 | Never thực hành a stroke past the điểm where cách cầm vợt pressure has climbed back UP. Stop. Reset. | Đừng tập cú nào quá điểm áp lực *tăng ngược* lên. Dừng. Reset. |
| 3 | Warm up the cách cầm vợt before the body. Squeeze a tennis bóng 10 times before stepping on court. | Khởi động cách cầm vợt trước thân. Bóp bóng tennis 10 lần trước khi vào sân. |
...
| 2 | PRE-POINT | 10-20 sec before each điểm | The 2-second ritual | Trước điểm | 10-20 giây trước mỗi điểm | Nghi thức 2 giây |
...
|---|---|---|
| Serving for the set | Breathe. Bounce. Slow Phát Bóng to Cú Trái Tay. Routine is your friend. | Thở. Nảy. Giao chậm về Cú Trái Tay. Nghi thức là bạn. |
| Serving for the trận | Same routine. Same rhythm. Trust the thực hành. | Cùng nghi thức. Cùng nhịp. Tin tập luyện. |
...
| 2 | DRIFT | 15 sec | Walk slowly to the back of the court, no vợt | Tĩnh (stillness) | Trôi | Đi chậm ra cuối sân, không cầm vợt | Tĩnh (tĩnh lặng) |
...
│ │
│ 3. GROUNDSTROKES (Cú Thuận Tay & Cú Trái Tay) │
│ • "Drop the vợt, don't pull the arm" (L1) │
│ • "Hop, then turn" (L2) │
│ • "One side locks, one side flies" — Thực-Hư (L3) │
│ • "2-second pause after every good shot" (L4) │
│ • 2HB delỗi; 1HB = "for the brave" at 50+ │
│ • Slice for low bóngs, defense, approach (see Part 10) │
│ │
│ 4. THE Phát Bóng │
│ • "Edge — above — turn" (pronation, not wrist snap) │
│ • "One — two" (hips, then arm) │
│ • "Heavy weight pulling the arm" (gravity Phát Bóng) │
...
│ • Continental cách cầm vợt — always │
│ │
│ 6. RETURN OF Phát Bóng │
│ • Watch the toss, not the phát bóngr │
│ • Block on first phát bóngs, cú đẩy on second phát bóngs │
│ • Aim chéo sân, deep │
│ • Shorten swing (70%) │
│ • 3 patterns: block deep / cắt low / lob over │
│ │
│ 7. SINGLES STRATEGY │
...
│ • Change direction AFTER Độ sâu, not for its own sake │
└──────────────────────────────────────────────────────────────────────────────┘
```
---
...
┌──────────────────────────────────────────────────────────────────────────────┐
│ 8. DOUBLES TACTICS │
│ • Talk to your partner — every điểm │
│ • Move as a unit │
│ • Phát Bóng to the T or the body │
│ • Poach on high bóngs │
│ • Lob over the lưới player when in doubt │
│ • At 50+: doubles is the longevity ván │
│ │
│ 9. LOB & OVERHEAD (Vertical Game) │
│ • 4 lob types: defensive / offensive xoáy trên / cắt / passing │
│ • Sane Smash (delỗi): full trophy, 3→9 pressure │
│ • Max Slam (Tham khảo): only when you must │
│ • Defensive lob = your friend at 50+ │
│ │
│ 10. SLICE FAMILY (7-Shot Swiss Army Knife) │
│ • 7 variations: defensive / attacking / approach / return / Vôlei / │
│ lob / dropshot │
│ • Master cue: "Open the door, walk through" │
│ • Soft hands, firm contact — cắt is subtraction │
│ • Grip Continental for every cắt variation │
│ │
...
│ • 10-min warmup before every trận │
│ • Ice forearm 10 min after trận if over 50 │
│ │
│ 12. GRIP PRESSURE (THE DIAL YOU CONTROL EVERY SHOT) │
│ • Pressure is a dial, not a switch │
│ • 0-10 scale: 4 swing → 8 impact (Cú Thuận Tay) │
│ • 0-10 scale: 2 swing → 7 impact (Vôlei) │
│ • 0-10 scale: 4 swing → 9 impact (Phát Bóng) │
│ • Calm Zone (1-4) for swing, Strike Zone (6-9) for impact only │
│ • Sound: "pực" = clean xoáy trên, "bịch" = clean block, "phập" = clean cắt │
│ • "két" (frame) = death cách cầm vợt — release immediately │
│ • Master cue: "Loose trophy, fierce catch" / "Trophy lỏng, chụp dữ" │
│ │
│ 13. MENTAL GAME │
│ • 5-phase trận map: Warmup / Pre-Point / During / Between / Changeover │
│ • 4-step pre-điểm ritual: Bounce-Breathe-Body-Build (2 sec total) │
│ • 5 pressure điểms with protocols (serving for set/trận, 0-40, etc.) │
│ • 4-action loss recovery: Drop-Drift-Document-Drink (90 sec total) │
│ • "Drop shoulders, unclench jaw, shake hands, lengthen spine" │
│ • 50+ mental edge: perspective = the only tennis lợi thế that GROWS │
│ │
│ 14. THE MASTER CUE (the single line) │
│ │
│ "Tennis is a whip sport, not a hammer sport. │
│ And you are playing a 20-year ván." │
│ │
...
| File | What it is |
|---|---|
| `Compléte Tennis Manual — Master Tham khảo.md` | v1 (70 KB, 11 parts, EN-VI bilingual) — prephát bóngd as historical Tham khảo |
| `Compléte Tennis Manual — Master Tham khảo v2.md` | v2 (this file, ~130-150 KB, 14 parts) — current master Tham khảo |
...
|---|---|---|---|
| 1 | Cú Thuận Tay | `Deep Dives/Cú Thuận Tay/Cú Thuận Tay — L-Angle and Late Acceleration.md` (~30 KB) | Part 3 (L1) |
| 2 | Cú Thuận Tay | `Deep Dives/Cú Thuận Tay/Unit Turn and Racket Head Position.md` (~25 KB) | Part 3 (L2) |
| 3 | Cú Thuận Tay | `Deep Dives/Cú Thuận Tay/Khoa Vai Thuc Hu Axis.md` (~35 KB) | Part 3 (L3) |
| 4 | Cú Thuận Tay | `Deep Dives/Cú Thuận Tay/Cú Thuận Tay — Racket Embodiment.md` (~37 KB) | Part 3 (L4) + Part 1 (body schema) |
| 5 | Cú Trái Tay | `Deep Dives/Cú Trái Tay/Cú Trái Tay — The Mirror, The Whip & The Slice.md` (~54 KB) | Part 3 (Cú Trái Tay) |
| 6 | Cú Trái Tay | `Deep Dives/Cú Trái Tay/One-Handed Cú Trái Tay — The Full Deep Dive.md` (~79 KB) | Part 3 (1HB Tham khảo) |
...
| 10 | Cú Trái Tay | `Deep Dives/Cú Trái Tay/Slice - Low Ball Variation.md` (~5 KB) | Part 10 |
| 11 | Cú Trái Tay | `Deep Dives/Cú Trái Tay/Slice - Return Variation.md` (~5 KB) | Part 10 |
| 12 | Cú Trái Tay | `Deep Dives/Cú Trái Tay/Quick Tham khảo - Slice Cheat Sheet.md` (~2 KB) | Part 10 |
| 13 | Phát Bóng | `Deep Dives/Phát Bóng/Phát Bóng — The Gravity & Rotation Phát Bóng.md` (~47 KB) | Part 4 |
| 14 | Vôlei | `Deep Dives/Vôlei/Vôlei — The Art of Redirection.md` (~47 KB) | Part 5 |
| 15 | Footwork | `Deep Dives/Footwork/Footwork — The Art of Smart Movement.md` (~40 KB) | Part 2 |
| 16 | Return | `Deep Dives/Return of Phát Bóng/Return of Phát Bóng — Reading, Blocking, Surviving.md` (~46 KB) | Part 6 |
| 17 | Doubles | `Deep Dives/Doubles Tactics/Doubles Tactics — Communication, Formations & The 50+ Longevity Game.md` (~52 KB) | Part 8 |
| 18 | Doubles | `Deep Dives/Doubles Serves/Doubles Serves — The 4 Phát Bóng Patterns.md` (~62 KB) | Part 8 |
...
| — | Grip (specific) | `Deep Dives/Eastern Semi-Western Grip/Eastern Semi-Western Grip — The 30% Cú Thuận Tay Grips.md` (~50 KB) | Part 1 |
| — | Grip (transition) | `Deep Dives/Grip Change Map/Grip Change Map — The Compléte Sequence Guide.md` (~42 KB) | Part 1 |
...
> Part 9: *"The Sane Smash is the delỗi at 50+. The Max Slam is for the brave."*
> Part 10: *"Slice is the 50+ player's best friend: gentle on the body, buys time, disrupts rhythm."*
> Part 12: *"Hold the bird, catch the bóng. Calm → spike → release. Every shot, every time."*
