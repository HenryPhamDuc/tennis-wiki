...
| The 9 Shots (Continental) | Vôlei, cắt, Phát Bóng, cú cao, lob, drop, approach, return | Continental |
| The 2 Shots (Semi-Western) | Cú Thuận Tay cú đánh nền, Cú Thuận Tay return | Eastern/Semi-Western |
| The 4 Contact Points | Heel pad, knuckle, thumb, index | Continental |
| The 3-Phase Pressure | Baby bird → Slingshot stone → Wrist lock (bỏ nhỏ exception) | Continental |
| The 4 Point Types | 0-1-3-4 cách cầm vợt changes per điểm type | Grip Change Map |
| The 8 Grip Transitions | All cách cầm vợt changes in 1 second | Grip Change Map |
...
| The 6 Common Errors | Fumbling, Western, Continental on Cú Thuận Tay, etc. | All 4 cách cầm vợt deep dives |
...
- Added the "How to Use" guide — before, during, and after the trận. The 50+ player knows exactly when to glance at the card (before Phát Bóng, between điểms, at changeover).
- Added the 3 sound cues (Bộp, Bịch, Phập) as a unique feature. The sound cues are the only audio Tham khảo on the card — useful for self-diagnosis without looking.
...
|---|---|
| Continental Grip | The 9-shot unlock, the 4 contact điểms, the 3-phase pressure — all on the card |
...
| Compléte Manual v2 | Roll the 17 deep dives (this + 16 others) into a single ~190-page master Tham khảo |
| Grip Pocket Card v2 (per-stroke) | A 1-page card for each major shot — Vôlei card, Phát Bóng card, Cú Thuận Tay card, cắt card, doubles card |
