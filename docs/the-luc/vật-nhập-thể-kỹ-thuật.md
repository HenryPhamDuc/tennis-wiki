---
title: "Lớp trong: Vật nhập thể (Racquet Embodiment)"
...
```mermaid
graph TD
    A[Vật nhập thể] --> B[Proprioception & Neuro-Controller]
    A --> C[Automaticity]
    A --> D[Proactive reaction]
    A --> E[2nd nature / habit]
    B --> F[Não tích hợp vợt]
    C --> G[Tiểu não + hạch nền]
    D --> H[Dự đoán 100-150ms]
    E --> I[Myelin bọc dây thần kinh]
```
